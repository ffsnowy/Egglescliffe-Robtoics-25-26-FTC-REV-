...
public class DriveSystem {
  ...
  // Speed should stay in the range -1 to 1
  ...
  public void setMotorPowers(double x, double y, double rotation) {
    final double strafeCorrection = 1.0; //this is up to driver preferences so can be modified as needed, tho if different people like different numbers make a list or smth bc we ain't changing it mid comp, make different copies of the same code for different people or smth
    ...
    // No testing to be done, if the wheels are backwards, use
  ...
  public void telemetry(Telemetry telemetry) {
    ...
    telemetry.addData("Robot Heading (rad)", robotHeading);
    telemetry.addData("Yaw (rad)", imu.getRobotYawPitchRollAngles().getYaw(AngleUnit.RADIANS));
